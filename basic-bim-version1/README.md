...
A BIM-as-code / IfcOpenShell generation experiment.

`basic-bim` is a monadic DSL embedded in Flix to generate IFC 
BIM models via Python.
...
FreeCAD, etc. The Python environment to run the generated code 
must include the `IfcOpenShell` package, currently version 0.8.4, 
