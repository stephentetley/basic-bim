...
project = ifcopenshell.api.root.create_entity(file=ifcfile, ifc_class="IfcProject", name="Wall Extruded Polyline Project")
...
# Write out to a file
ifcfile.write("./output/wall_polycurve1.ifc")
